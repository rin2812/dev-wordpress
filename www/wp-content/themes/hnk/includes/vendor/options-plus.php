...
if ( ! function_exists( 'hnk_options_plus_uri' ) ) {
	add_filter( 'op/directory_uri', 'hnk_options_plus_uri' );
	 ...
	 * @return  string
	 */
	function hnk_options_plus_uri( $uri ) {
...
if ( ! function_exists( 'hnk_options_plus_path' ) ) {
	add_filter( 'op/directory_path', 'hnk_options_plus_path' );
	 ...
	 * @return  string
	 */
	function hnk_options_plus_path( $path ) {
